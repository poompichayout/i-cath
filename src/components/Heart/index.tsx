  ...
  return (
    ...
    >
      ...
      <path
        ...
        stroke="#000"
        strokeMiterlimit="10"
        d="M217.8,251.3c0,0,9.3-6.6,26.4-5.6c17.1,1,26.4,9.9,26.4,9.9
        l-1.4,18.6l-1.2,37.8c0,0,2,8.9,2.6,13.5c0.6,4.5,0.9,14,0.9,14l0,9c0,0-1.5,7-1.7,11.1c-0.2,4,0.3,9.2,0.3,9.2s-1.9,16.7-5.3,19.5
        s-8.3,8.3-12.3,9.5c-4,1.1-11,3.7-18.4,2.4c-7.4-1.3-12.7-2.5-17.6-6.4c-4.9-3.9-4.9-3.9-4.9-3.9l-4.4,3.7c0,0-8.5-13.4-8.1-20.5
        s1.3-10.1,1.3-10.1l0.8-4.6c0,0-0.5-11.6,0.3-18c0.7-6.4,2.4-16.6,3.4-20.9c1-4.3,3.9-11.7,3.9-11.7l3-28.3l3.1-15.5L217.8,251.3z"
      ></path>
      <path
        style={PATH_STYLE}
        ref={lungBedRef}
        ...
        s34.2-2.8,50-1.4c0,0,18.5,2,25.4,3.5s19.6,4.1,24.1,6c4.5,1.9,6.7,5,13.6-0.7c6.9-5.7,10.1-16.8,10.1-16.8s1-4.5,0.5-8.6
        c-0.5-4.1-3.7-7.7-3.7-7.7l-2-1.7l-16.1-5.8l4.1-10.1c0,0,0-3.7-8.2-6.2c-8.2-2.5-12.5,1.9-12.5,1.9l-2.8,5.8L397,163l-18.9-3.7
        l-20.6-2.7l-19.6-1.1l-14,0.9l-8.5,1.2L314.4,159z"
      ></path>
